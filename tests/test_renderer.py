...
def test_render_dashboard_uses_destination_code_for_generated_landmark_assets(tmp_path: Path) -> None:
    output = tmp_path / "dest-key-landmark.png"
    aircraft = Aircraft("484506", "KLM1287", "PH-BVA", "B738", 52.12, 5.12, 35600, 445, 162, 1.9)
    weather = Weather(16.2, 32, 2, 21.0, 130)
    route = Route(origin="AMS", destination="AAL", destination_country="DK")
    prediction = PassagePrediction(1.4, 32, True)
    calls: list[str] = []
