...
class Settings:
    ...
    planespotters_image_width: int = 500
    planespotters_image_height: int = 268
    ...
    def from_env(cls) -> "Settings":
        ...
        settings = cls(
            ...
            planespotters_image_width=int(os.getenv("PLANESPOTTERS_IMAGE_WIDTH", "500")),
            planespotters_image_height=int(os.getenv("PLANESPOTTERS_IMAGE_HEIGHT", "268")),
        )
        settings.validate()
        return settings
